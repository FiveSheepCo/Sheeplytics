-- Migration number: 0009 	 2024-10-23T07:55:00.000Z
...
ALTER TABLE Choices RENAME TO Choices_TEMP;
...
ALTER TABLE ChoicesEventHistory RENAME TO ChoicesEventHistory_TEMP;
...
INSERT INTO Choices (choice_id, app_id, user_id, event_name, choice_value)
SELECT choice_id, app_id, user_id, event_name, choice_value
FROM Choices_TEMP;
...
INSERT INTO ChoicesEventHistory (history_entry_id, choice_id, event_id)
SELECT history_entry_id, choice_id, event_id
FROM ChoicesEventHistory_TEMP;
